...
public class FoodMenuActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<FoodItems, ViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FoodItems, ViewHolder>(
                    FoodItems.class,
                        R.layout.row,
                        ViewHolder.class,
                        mRef
        ...
        FirebaseRecyclerAdapter<FoodItems, ViewHolder> firebaseRecyclerAdapter2 = new FirebaseRecyclerAdapter<FoodItems, ViewHolder>(
                FoodItems.class,
                R.layout.row,
                ViewHolder.class,
                mRef2
